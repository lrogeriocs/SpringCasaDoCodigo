	...
	<c:url value="/" var="contextPath" />
	  <meta charset="utf-8"/>
		...
		<link href='http://fonts.googleapis.com/css?family=Droid+Sans:400,700'
			rel='stylesheet'/>
		<link <c:url value= "/resources/css/fonts.css"/> 
			rel="stylesheet" type="text/css" media="all" />
  ...
  <header id="layout-header">
	  ...
	  <form action='<c:url value="/carrinho/add"/>'  method="post" class="container">
	    <ul id="variants" class="clearfix">
	    	 ...
	    	 <c:forEach items="${produto.precos }" var="preco">
	    	  <li class="buy-option">
	            <input type="radio" name="id" class="variant-radio" value="${preco.tipo }"  checked="checked"  />
	...
	<div class="container">
	  ...
	  <section class="data product-detail">
	    ...
	    <p></p>
	    <p>Data de publicação:'<fmt:formatDate  pattern="dd/MM/yyyy" value="${produto.dataLancamento }"/>'  </p>
